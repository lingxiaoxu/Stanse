...
const TRANSLATIONS = {
  [Language.EN]: {
    ...
    menu: {
        ...
        api_key_title: "OpenClaw Skill API Key",
        api_key_desc: "Use this key to authenticate with OpenClaw skills. Keep it secret.",
        api_key_generate: "GENERATE API KEY",
        api_key_regenerate: "REGENERATE",
        api_key_copy: "COPY",
        api_key_copied: "COPIED!",
        api_key_generating: "GENERATING...",
        api_key_none: "No API key generated yet",
        api_key_last_used: "Last used",
        api_key_never_used: "Never used",
        api_key_success: "API key generated! Copy it now — it won't be shown again.",
        api_key_error: "Failed to generate API key. Please try again.",
        api_key_uncalibrated: "Complete the Fingerprint survey first.",
        api_key_warning: "Regenerating will invalidate your current key.",
    ...
    settings: {
        ...
        sub_demo: "Include demo users in Union tab",
        ai_assistant_button: "Show AI Button",
        sub_ai_assistant_button: "Display floating chat button",
  ...
  [Language.ZH]: {
    ...
    menu: {
        ...
        api_key_title: "OpenClaw Skill API Key",
        api_key_desc: "使用此密钥与 OpenClaw Skill 进行身份验证。请妥善保管，不要泄露。",
        api_key_generate: "生成 API Key",
        api_key_regenerate: "重新生成",
        api_key_copy: "复制",
        api_key_copied: "已复制！",
        api_key_generating: "生成中...",
        api_key_none: "尚未生成 API Key",
        api_key_last_used: "最近使用",
        api_key_never_used: "从未使用",
        api_key_success: "API Key 已生成！请立即复制，此后将不再显示完整密钥。",
        api_key_error: "生成 API Key 失败，请重试。",
        api_key_uncalibrated: "请先完成 Fingerprint 调查。",
        api_key_warning: "重新生成将使当前密钥失效。",
        premium: "高级订阅",
    ...
    aiChat: {
        ...
        emptyHint: "询问品牌、政治话题，或获取个性化推荐！",
        thinking: "思考中...",
        providerLabel: "AI 提供商：",
        providerGemini: "Gemini（默认）",
        providerChatGPT: "ChatGPT",
        providerClaude: "Claude",
        providerLocal: "本地模型",
        apiKeyLabel: "API 密钥：",
        ...
        providerNotConfigured: "此提供商需要 API 密钥",
        errorMessage: "获取响应失败，请重试。",
        clearHistory: "清除历史",
    ...
    settings: {
        ...
        sub_demo: "联合页显示演示用户",
        ai_assistant_button: "显示AI按钮",
        sub_ai_assistant_button: "显示浮动聊天按钮",
        camera: "摄像头权限",
        sub_camera: "用于产品扫描",
  ...
  [Language.JA]: {
    ...
    menu: {
        ...
        api_key_title: "OpenClaw Skill API Key",
        api_key_desc: "このキーを使ってOpenClawスキルを認証します。秘密にしてください。",
        api_key_generate: "API Keyを生成",
        api_key_regenerate: "再生成",
        api_key_copy: "コピー",
        api_key_copied: "コピー済み！",
        api_key_generating: "生成中...",
        api_key_none: "API Keyはまだ生成されていません",
        api_key_last_used: "最終使用",
        api_key_never_used: "未使用",
        api_key_success: "API Keyが生成されました！今すぐコピーしてください。二度と表示されません。",
        api_key_error: "API Keyの生成に失敗しました。再試行してください。",
        api_key_uncalibrated: "先にFingerprintアンケートを完了してください。",
        api_key_warning: "再生成すると現在のキーが無効になります。",
    ...
    aiChat: {
        title: "AIアシスタント",
        subtitle: "マルチプロバイダーLLMチャット",
        inputPlaceholder: "何でも聞いてください...",
        emptyState: "AIアシスタントとの会話を開始",
        emptyHint: "ブランド、政治、またはパーソナライズされたおすすめについて質問してください！",
        thinking: "考え中...",
        providerLabel: "AIプロバイダー：",
        providerGemini: "Gemini（デフォルト）",
        providerChatGPT: "ChatGPT",
        providerClaude: "Claude",
        ...
        providerNotConfigured: "このプロバイダーにはAPIキーが必要です",
        errorMessage: "応答の取得に失敗しました。もう一度お試しください。",
        clearHistory: "履歴をクリア",
        confirmClear: "すべてのチャット履歴をクリアしますか？",
        save: "保存",
        cancel: "キャンセル",
        default: "デフォルト",
    ...
    sense: {
        ...
        globe_title: "グローバルインテリジェンスマップ",
        globe_hint: "ドラッグで回転 • スクロールでズーム • マーカーをクリックして詳細表示",
        globe_markers_count: "個のマーカー",
        marker_news: "ニュース",
        marker_breaking: "速報ニュース",
        marker_conflict: "紛争地帯",
        marker_birth: "出生国",
        marker_current: "現在地",
        marker_search: "検索結果",
        marker_location: "位置",
        marker_severity: "重要度",
        marker_view_article: "全記事を表示"
    },
    union: {
        title: "ザ・ユニオン",
        subtitle: "集団行動 • 分散型権力",
    ...
    settings: {
        ...
        ai_assistant_button: "AIボタンを表示",
        sub_ai_assistant_button: "チャットボタンを表示",
        sub_demo: "ユニオンにデモユーザー表示",
        camera: "カメラアクセス",
        sub_camera: "製品スキャン用",
  ...
  [Language.FR]: {
    ...
    menu: {
        ...
        subs: {
            ...
            aiAssistant: "Discuter avec l'IA",
        ...
        api_key_title: "OpenClaw Skill API Key",
        api_key_desc: "Utilisez cette clé pour authentifier les skills OpenClaw. Gardez-la secrète.",
        api_key_generate: "GÉNÉRER UNE CLÉ API",
        api_key_regenerate: "REGÉNÉRER",
        api_key_copy: "COPIER",
        api_key_copied: "COPIÉ !",
        api_key_generating: "GÉNÉRATION...",
        api_key_none: "Aucune clé API générée",
        api_key_last_used: "Dernière utilisation",
        api_key_never_used: "Jamais utilisée",
        api_key_success: "Clé API générée ! Copiez-la maintenant — elle ne sera plus affichée.",
        api_key_error: "Échec de la génération. Veuillez réessayer.",
        api_key_uncalibrated: "Complétez d'abord le sondage Fingerprint.",
        api_key_warning: "La regénération invalidera votre clé actuelle.",
    ...
    aiChat: {
        title: "ASSISTANT IA",
        subtitle: "Chat LLM Multi-Fournisseurs",
        inputPlaceholder: "Posez-moi une question...",
        emptyState: "Commencez une conversation avec votre assistant IA",
        emptyHint: "Posez des questions sur les marques, la politique ou obtenez des recommandations personnalisées !",
        thinking: "Réflexion...",
        providerLabel: "Fournisseur IA :",
        providerGemini: "Gemini (Par défaut)",
        providerChatGPT: "ChatGPT",
        providerClaude: "Claude",
        providerLocal: "Modèle Local",
        apiKeyLabel: "Clé API :",
        apiKeyPlaceholder: "Entrez votre clé API",
        configureProvider: "Configurer le Fournisseur",
        providerNotConfigured: "Ce fournisseur nécessite une clé API",
        errorMessage: "Échec de la réponse. Veuillez réessayer.",
        clearHistory: "Effacer l'historique",
        confirmClear: "Effacer tout l'historique de chat ?",
        save: "ENREGISTRER",
        cancel: "ANNULER",
        default: "Par défaut",
    ...
    sense: {
        ...
        globe_title: "CARTE INTELLIGENCE GLOBALE",
        globe_hint: "Glisser pour tourner • Défiler pour zoomer • Cliquer marqueurs pour détails",
        globe_markers_count: "marqueurs",
        marker_news: "ACTUALITÉS",
        marker_breaking: "FLASH INFO",
        marker_conflict: "ZONE DE CONFLIT",
        marker_birth: "PAYS DE NAISSANCE",
        marker_current: "LOCALISATION ACTUELLE",
        marker_search: "RÉSULTAT RECHERCHE",
        marker_location: "Localisation",
        marker_severity: "Gravité",
        marker_view_article: "Voir Article Complet"
    },
    union: {
        title: "L'UNION",
    ...
    settings: {
        ...
        strict: "MODE STRICT",
        reset_all_settings: "RÉINITIALISER TOUT",
        ...
        sub_demo: "Utilisateurs démo dans Union",
        ai_assistant_button: "Bouton AI",
        sub_ai_assistant_button: "Afficher bouton de chat",
        camera: "ACCÈS CAMÉRA",
  ...
  [Language.ES]: {
    ...
    menu: {
        ...
        api_key_title: "OpenClaw Skill API Key",
        api_key_desc: "Use esta clave para autenticarse con los skills de OpenClaw. Manténgala en secreto.",
        api_key_generate: "GENERAR CLAVE API",
        api_key_regenerate: "REGENERAR",
        api_key_copy: "COPIAR",
        api_key_copied: "¡COPIADO!",
        api_key_generating: "GENERANDO...",
        api_key_none: "No se ha generado ninguna clave API",
        api_key_last_used: "Último uso",
        api_key_never_used: "Nunca usada",
        api_key_success: "¡Clave API generada! Cópiela ahora — no se mostrará de nuevo.",
        api_key_error: "Error al generar la clave API. Inténtelo de nuevo.",
        api_key_uncalibrated: "Complete primero la encuesta Fingerprint.",
        api_key_warning: "Regenerar invalidará su clave actual.",
    ...
    aiChat: {
        title: "ASISTENTE IA",
        subtitle: "Chat LLM Multi-Proveedor",
        inputPlaceholder: "Pregúntame cualquier cosa...",
        emptyState: "Comienza una conversación con tu asistente IA",
        emptyHint: "¡Pregunta sobre marcas, política u obtén recomendaciones personalizadas!",
        thinking: "Pensando...",
        providerLabel: "Proveedor de IA:",
        providerGemini: "Gemini (Por defecto)",
        providerChatGPT: "ChatGPT",
        providerClaude: "Claude",
        providerLocal: "Modelo Local",
        apiKeyLabel: "Clave API:",
        apiKeyPlaceholder: "Ingrese su clave API",
        configureProvider: "Configurar Proveedor",
        providerNotConfigured: "Este proveedor requiere una clave API",
        errorMessage: "Error al obtener respuesta. Por favor, inténtelo de nuevo.",
        clearHistory: "Borrar historial",
        confirmClear: "¿Borrar todo el historial de chat?",
        save: "GUARDAR",
        cancel: "CANCELAR",
        default: "Por defecto",
    ...
    sense: {
        ...
        globe_title: "MAPA INTELIGENCIA GLOBAL",
        globe_hint: "Arrastrar para rotar • Desplazar para zoom • Clic marcadores para detalles",
        globe_markers_count: "marcadores",
        marker_news: "NOTICIAS",
        marker_breaking: "ÚLTIMA HORA",
        marker_conflict: "ZONA DE CONFLICTO",
        marker_birth: "PAÍS DE NACIMIENTO",
        marker_current: "UBICACIÓN ACTUAL",
        marker_search: "RESULTADO BÚSQUEDA",
        marker_location: "Ubicación",
        marker_severity: "Gravedad",
        marker_view_article: "Ver Artículo Completo"
    },
    union: {
        title: "LA UNIÓN",
    ...
    settings: {
        ...
        sub_demo: "Usuarios demo en Unión",
        ai_assistant_button: "Botón AI",
        sub_ai_assistant_button: "Mostrar botón de chat",
